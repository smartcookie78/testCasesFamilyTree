...
namespace atFrameWork2.SeleniumFramework
{
    public class MobileDriverActions : BaseDriverActions
    {
        ...
        public static AppiumDriver GetNewMobileDriver()
        {
            ...
            appiumOptions.App = "D:\\Downloads\\bitrix24_university.apk"; // Путь к приложению
            ...
            appiumOptions.AddAdditionalAppiumOption(MobileCapabilityType.NewCommandTimeout, 100); // Таймаут для новой команды
